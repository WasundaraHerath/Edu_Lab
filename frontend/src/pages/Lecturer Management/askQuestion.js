    ...
    <>
      <div className="main-container-askQuestion">
        ...
        <div className="lecform">
          ...
          <Form {...layout} form={form} name="lecturer management" onFinish={onFinish} validateMessages={validateMessages}>
            ...
            <Form.Item name={['topic']} label="Topic" rules={[{type: 'string',max:60, required: true, },]}>
            ...
            <Row>
              <Button className="resetBtn" type="primary" htmlType="submit" >
                ASK
              </Button>
              <Button className="resetBtn" htmlType="button" onClick={onReset}  >
                RESET
              </Button>
            </Row>
            </Form.Item>
